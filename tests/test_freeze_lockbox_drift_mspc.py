...
from secom.pipeline import _operational_threshold, _psi_for_feature
...
def test_operational_threshold_enforces_cap() -> None:
    ...
    t = _operational_threshold(scores=scores, y_true=y, week_labels=weeks)
